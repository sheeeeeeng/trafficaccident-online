  ...
  <div class="row">
    <div class="col-md-12">
        <div class="col-md-12 text-right">
            <button id="A1A2A3_btn" class="btn btn-primary">查詢</button>
            <button id="A1A2A3_csv" class="btn btn-primary">匯出報表</button>
        </div>
    </div>
  </div>
</div>
...
<div class="container">
  <div class="row">
    <div class="col-md-12">
        <div class="container">
            <canvas id="A1A2A3Chart" width="300" height="200"></canvas>
        </div>
    </div>
  </div>
</div>
...
<script src="js/A1A2A3.js"></script>
@endsection("content")
