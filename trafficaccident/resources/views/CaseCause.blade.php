  ...
  <div class="row">
    <div class="col-md-12">
        <div class="col-md-12 text-right">
            <button id="Case_Cause_btn" class="btn btn-primary">查詢</button>
            <button id="Case_Cause_csv" class="btn btn-primary">匯出報表</button>
        </div>
    </div>
  </div>
</div>
...
<div class="container">
  <div class="row">
    <div class="col-md-12">
        <div class="container">
            <canvas id="CauseCountPieChart" width="300" height="300"></canvas>
        </div>
    </div>
  </div>
</div>
...
<script src="js/CaseCause.js"></script>
@endsection("content")
